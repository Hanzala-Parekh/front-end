              ...
              <li>
                ...
                <div className="mega-dropdown">
                  <div className="news-post standard-post">
                    ...
                    <h2>
                      <a href="single-post.html">Aliquam tincidunt mauris eu risus.</a>
                    </h2>
                  ...
                  <div className="news-post standard-post">
                    ...
                    <h2>
                      <a href="single-post.html">Morbi in sem quis dui placerat ornare.</a>
                    </h2>
                    <ul className="post-tags">
                      <li>
                        by <a href="/">John Smith</a>
                  ...
                  <div className="news-post standard-post">
                    ...
                    <h2>
                      <a href="single-post.html">Quisque volutpat mattis semper suscipit eros.</a>
                    </h2>
                    <ul className="post-tags">
                      <li>
                        by <a href="/">John Smith</a>
